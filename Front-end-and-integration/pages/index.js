...
export default function Home(){
  ...
  return (
   ...
   <div className='text-center text-[150%] lg:text-[220%] md:text-[180%] pt-[1.5cm] font-[500] text-[#502]'>Explore, discover and make your photos work for you on Rootstock</div>
